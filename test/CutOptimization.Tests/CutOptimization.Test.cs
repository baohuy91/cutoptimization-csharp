...
namespace CutOptimization.Tests
{
    public class CutOptimizationTests
    {
        ...
        [InlineDataAttribute(6000d, 0d, 30d, 200d, new double[] { 2158d, 1656d, 1458d, 734d, 646d, 546d }, new int[] { 1065, 83, 565, 565, 556, 556 }, 778 /*738*/, 215650d /*38050d */, 0.05 /*0.01*/)]
        [InlineDataAttribute(1000d, 0d, 30d, 200d, new double[] { 150d }, new int[] { 10 }, 2, 900d /*300d*/, 0.30 /*0.15*/)]
