...
namespace lpsolve_macos
{
    public static class Lpsolve
    {
        ...
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        [DllImport("liblpsolve55.dylib", CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        ...
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_col_name(IntPtr lp, int column);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_col_name", SetLastError = true)] private unsafe static extern IntPtr get_col_name_c(IntPtr lp, int column);
#endif
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_lp_name(IntPtr lp);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_lp_name", SetLastError=true)] private unsafe static extern IntPtr get_lp_name_c(IntPtr lp);
#endif
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_origcol_name(IntPtr lp, int column);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_origcol_name", SetLastError=true)] private unsafe static extern IntPtr get_origcol_name_c(IntPtr lp, int column);
#endif
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_origrow_name(IntPtr lp, int row);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_origrow_name", SetLastError=true)] private unsafe static extern IntPtr get_origrow_name_c(IntPtr lp, int row);
#endif
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_row_name(IntPtr lp, int row);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_row_name", SetLastError=true)] private unsafe static extern IntPtr get_row_name_c(IntPtr lp, int row);
#endif
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        //[DllImport("liblpsolve55.dylib", SetLastError=true)] public static extern string get_statustext(IntPtr lp, int statuscode);
#if lpsolve_unsafe
    [DllImport("liblpsolve55.dylib", EntryPoint = "get_statustext", SetLastError=true)] private unsafe static extern IntPtr get_statustext_c(IntPtr lp, int statuscode);
#endif
        [DllImport("liblpsolve55.dylib", SetLastError = true)]
        ...
        //private static extern int SetEnvironmentVariableA([MarshalAs(UnmanagedType.LPStr)] string lpName, [MarshalAs(UnmanagedType.LPStr)] string lpValue);
        //[DllImport("kernel32", CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        //private static extern int GetEnvironmentVariableA([MarshalAs(UnmanagedType.LPStr)] string lpName, [MarshalAs(UnmanagedType.LPStr)] string lpBuffer, int nSize);

        private static bool SetEnvironmentVariable(string  Name, string val)
        {
            //return NativeMethods.SetEnvironmentVariableA(Name, val) == 0 ? false : true;
        ...
        public static bool Init(string  dllPath)
        {
            ...
            if ( dllPath.Length == 0 )
            {
                ...
                dllPath = System.IO.Directory.GetCurrentDirectory();
            }
            Buf = dllPath;
